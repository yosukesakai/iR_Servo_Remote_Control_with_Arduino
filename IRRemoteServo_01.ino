...
#define DATA_POINT  6           // 受信したデータから読取る内容のデータ位置 Panasonic Projector Remote Controller >> 6
...
void loop()
{
     ...
     if (ans != 0) {
          switch(ans) {
           case 0x10:     myservo_1.write(00);           // get signal 10 (button "1" ) then set servo position 2.4 degree 
                          delay( 30 );   
                          //myservo_1.write(30);  
                    break ;
           case 0x11:     myservo_1.write(105);         // get signal 11 (button "2" ) then set servo position 178.1 degree  
                          delay( 30 );  
                          //myservo_1.write(150);  
                   break ;
           case 0xd7: 
