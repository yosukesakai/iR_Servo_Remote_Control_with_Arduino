              ...
              switch(ans) {
               case 0x10:     
                   ...
                   for (int i=0; i <= 1000; i++){
                     ...
                     myservo_1.write(00);           // get signal 10 (button "1" ) then set servo position 2.4 degree 
                                  delay( 3000 );         
                      
                      myservo_1.write(105);         // get signal 11 (button "2" ) then set servo position 178.1 degree  
                                  delay( 3000 );  
